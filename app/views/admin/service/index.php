                  ...
                  <table class="min-w-full border text-center">
                    ...
                    <tbody>
                          ...
                          <tr class="border-b">
                            ...
                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r">
                              <img class="h-12 w-full object-contain" alt="">
                            </td>
                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 border-r space-x-2"><a href="edit.php" class="underline text-primary">sửa</a><a href="" class="underline text-primary">xoá</a></td>
