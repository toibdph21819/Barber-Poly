    ...
    <div class="flex">
      ...
      <main class="flex-1 h-[100vh] overflow-y-scroll scroll-smooth">
        ...
        <div class="bg-white p-5 min-h-[100vh] flex items-center">
          <form name="form" class="w-full  mx-auto p-5 rounded-md  border" enctype="multipart/form-data" action="index.php?update&id=<?= $get_id ?>" method="post">
            ...
            <h2 class="text-xl text-center my-5">Sửa dichj vu</h2>
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
              <img src="" class="w-20 h-20 object-contain  mx-auto " alt="">
              <div class="w-full px-3">
        
                <input type="hidden" value="" name="prev_img">
                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="">
                  hình ảnh
                </label>
