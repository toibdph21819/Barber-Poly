            ...
            <div class="form">
                ...
                <form action="">
                    ...
                    <div class="input-form">
                        <span>Chọn dịch vụ</span>
                        <br>
                        <select name="" class="font-mono rounded-md ">
                          <option class="font-mono" >dịch vụ 1</option>
                          <option class="font-mono"  >dịch vụ 2</option>
                          <option  class="font-mono" >dịch vụ 3</option>
                          <option  class="font-mono" >dịch vụ 4</option>
...
>>>>>>> 2c33a8d430e4587a4b3b383446a22601728512b9
